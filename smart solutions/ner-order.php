...
if (!empty($user_id)) {
    ...
    <html>
        <head>
            ...
            <title>Order List - SMART SOLUTIONS</title>
                                        ...
                                        <tr>
                                            <td align="left">
                                                <table cellpadding="2" cellspacing="2" border="0" width="100%">
                                                    ...
                                                    <?php
                                                    $ctr = 0;
                                                    $query_order = "SELECT o.od_id,o.od_invoice,o.od_billing_amount,o.od_date,o.od_status,o.od_billing_name,o.od_billing_address,u.name FROM i_order o JOIN users u WHERE o.user_id= u.id ";
